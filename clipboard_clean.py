...
Prefers CF_HDROP on Windows via clipboard_win. Falls back to copying
the file path text to the clipboard on other platforms.
"""
...
if sys.platform == "win32":
    try:
        ...
        try:
            ...
            def copy_gif_to_clipboard_ctypes(path: str) -> bool:
                # type: ignore
                return False

            def copy_gif_to_clipboard_pywin32(path: str) -> bool:
                # type: ignore
                return False
