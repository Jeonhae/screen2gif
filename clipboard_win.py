...
This module mirrors the intended clipboard behavior and logs to
``logs/clipboard_debug.log`` for troubleshooting.
"""
    ...
    try:
        ...
        try:
            win32clipboard.SetClipboardData(
                win32con.CF_UNICODETEXT, os.path.abspath(gif_path)
            )
        except Exception:
